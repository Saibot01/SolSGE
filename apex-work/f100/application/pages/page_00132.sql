...
wwv_flow_imp_page.create_page(
 p_id=>132
,p_name=>'Documento Cierre de Caja'
,p_alias=>'DOCUMENTO-CIERRE-CAJA'
,p_page_mode=>'MODAL'
,p_step_title=>'Arqueo y Cierre de Caja'
,p_autocomplete_on_off=>'OFF'
,p_inline_css=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* ===== Arqueo de Caja - mismo estilo visual que el KuDE (control interno) ===== */',
'html { background:#999; }',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(36000000000132001)
,p_plug_name=>'Arqueo'
...
'BEGIN',
'  RETURN WKSP_WORKPLACE.FN_CIERRE_CAJA_HTML(:P132_ID_CAJA);',
'END;'))
,p_lazy_loading=>false
,p_plug_source_type=>'NATIVE_DYNAMIC_CONTENT'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(36000000000132002)
,p_name=>'P132_ID_CAJA'
,p_item_sequence=>20
