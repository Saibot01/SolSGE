...
,p_page_mode=>'MODAL'
,p_step_title=>'Reporte Presupuesto'
...
'',
'  v_retorno CLOB;',
'  v_dias    VARCHAR2(20) := NVL(WKSP_WORKPLACE.FN_GET_PARAMETRO(''DIAS_VIGENCIA_PRESUPUESTO'',''NUMERICO''), ''15'');',
'BEGIN',
...
'      <div contenteditable>',
unistr('        <p>CONDICI\00D3N DE LA VENTA: <br>Atenci\00F3n: La validez de esta orden de venta es de '' || v_dias || '' d\00EDas. Por favor, confirme su pedido antes de la fecha de vencimiento para garantizar precios y disponibilidad.</p>'),
'      </div>',
'    </aside>'';',
'  END LOOP;',
'',
