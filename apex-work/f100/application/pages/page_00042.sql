...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9807608099312900)
,p_name=>'P42_PLAZO_PAGO_DIAS'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(9800056077312818)
,p_item_source_plug_id=>wwv_flow_imp.id(9800056077312818)
,p_prompt=>'Plazo de pago (dias)'
,p_source=>'PLAZO_PAGO_DIAS'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_field_template=>1609121967514267634
,p_item_template_options=>'#DEFAULT#'
,p_is_persistent=>'N'
,p_help_text=>'Dias desde la emision del comprobante para calcular el vencimiento de la cuenta por pagar.'
);
