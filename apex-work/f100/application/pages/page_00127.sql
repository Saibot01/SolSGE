...
wwv_flow_imp_page.create_page(
 p_id=>127
,p_name=>'Documento Nota de Credito'
,p_alias=>'DOCUMENTO-NOTA-CREDITO'
,p_page_mode=>'MODAL'
,p_step_title=>'Documento Nota de Credito'
,p_autocomplete_on_off=>'OFF'
,p_inline_css=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* ===== KuDE - Representacion Grafica de Nota de Credito Electronica ===== */',
'html { background:#999; }',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(23091270000000001)
,p_plug_name=>'KuDE Nota de Credito'
...
'BEGIN',
'  RETURN WKSP_WORKPLACE.FN_KUDE_NOTA_CREDITO_HTML(:P127_ID_COMPROBANTE);',
'END;'))
,p_lazy_loading=>false
,p_plug_source_type=>'NATIVE_DYNAMIC_CONTENT'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23091270000000002)
,p_name=>'P127_ID_COMPROBANTE'
,p_item_sequence=>20
