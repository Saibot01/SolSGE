...
'from   productos pro',
'where  pro.activo = ''S''',
'  and  exists (select 1 from PRODUCTO_PROVEEDORES pp',
'               where pp.id_producto = pro.id_producto',
'                 and pp.estado = ''ACTIVO''',
'                 and pp.fecha_fin is null',
'                 and pp.fecha_inicio <= trunc(sysdate))',
'  and  exists (select 1 from MARGEN_CATEGORIA mc',
'               where mc.id_categoria = pro.id_categoria',
'                 and mc.categoria_cliente = :P54_TIP_CLIENTE',
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
':P54_PRE_UNITARIO := WKSP_WORKPLACE.FN_PRECIO_VENTA(:P54_PRODUCTO, :P54_TIP_CLIENTE);',
':P54_CANTIDAD := 1;'))
,p_attribute_02=>'P54_PRODUCTO,P54_TIP_CLIENTE'
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
':PRECIO_UNITARIO := WKSP_WORKPLACE.FN_PRECIO_VENTA(:ID_PRODUCTO, :P54_TIP_CLIENTE);',
':CANTIDAD := 1;',
':TOTAL := :PRECIO_UNITARIO;'))
,p_attribute_02=>'ID_PRODUCTO,P54_TIP_CLIENTE'
