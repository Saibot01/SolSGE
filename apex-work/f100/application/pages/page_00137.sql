...
wwv_flow_imp_page.create_page(
 p_id=>137
,p_name=>'Generador de Informe de Cobros'
,p_alias=>'GENERADOR-INFORME-COBROS'
,p_step_title=>'Generador de Informe de Cobros'
,p_autocomplete_on_off=>'OFF'
,p_inline_css=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Informe de Cobros - mismo estilo que el arqueo/KuDE (scope .kude) */',
'.kude { max-width:8.5in; margin:0 auto; background:#fff;',
'   font:12px/1.35 ''Open Sans'',sans-serif; color:#222; padding:0.4in;',
'   border:1px solid #ddd; }',
'.kude .ktit { background:#00695c; color:#fff; text-align:center; font-weight:bold;',
...
'.kude .bar { background:#00695c; height:14px; border-radius:3px; }',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(36000000000137020)
,p_plug_name=>'Informe'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_plug_display_point=>'BODY'
,p_ajax_items_to_submit=>'P137_DESDE,P137_HASTA,P137_OFICINA,P137_COBRADOR'
,p_function_body_language=>'PLSQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
'  RETURN WKSP_WORKPLACE.FN_INFORME_COBROS_HTML(',
'    TO_DATE(:P137_DESDE,''YYYY-MM-DD''),',
'    TO_DATE(:P137_HASTA,''YYYY-MM-DD''),',
'    :P137_OFICINA, :P137_COBRADOR);',
'END;'))
,p_plug_source_type=>'NATIVE_DYNAMIC_CONTENT'
);
--==================== Region Filtros (contenedor plano, se oculta al imprimir) ====
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(36000000000137010)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(36000000000137011)
,p_name=>'P137_DESDE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(36000000000137010)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(36000000000137012)
,p_name=>'P137_HASTA'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(36000000000137010)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(36000000000137013)
,p_name=>'P137_OFICINA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(36000000000137010)
,p_prompt=>'Sucursal'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(36000000000137014)
,p_name=>'P137_COBRADOR'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(36000000000137010)
,p_prompt=>'Cobrador'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT DISTINCT cobrador_nombre d, cobrador_cod r',
'  FROM WKSP_WORKPLACE.V_COBROS_MOV ORDER BY 1'))
,p_lov_display_null=>'YES'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(36000000000137016)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(36000000000137010)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(36000000000137017)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(36000000000137030)
,p_name=>'Generar informe'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(36000000000137016)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(36000000000137031)
,p_event_id=>wwv_flow_imp.id(36000000000137030)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(36000000000137020)
);
--==================== DA: Imprimir -> window.print() ====================
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(36000000000137032)
,p_name=>'Imprimir'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(36000000000137017)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(36000000000137033)
,p_event_id=>wwv_flow_imp.id(36000000000137032)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
