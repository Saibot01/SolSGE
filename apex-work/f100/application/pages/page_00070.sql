...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16598115173211800)
,p_name=>'P70_FORMA_PAGO'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>25
,p_item_plug_id=>wwv_flow_imp.id(12856286435396822)
...
'SELECT descripcion d, TO_CHAR(id_forma_pago) r',
'  FROM WKSP_WORKPLACE.FORMAS_PAGO',
' WHERE activo = ''S''',
...
,p_help_text=>unistr('Cr\00E9dito genera una Cuenta por Pagar (deuda al proveedor); Contado no.')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
);
wwv_flow_imp_page.create_page_item(
