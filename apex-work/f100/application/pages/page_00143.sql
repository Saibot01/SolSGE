...
wwv_flow_imp_page.create_page(
 p_id=>143
,p_name=>'Generador de Informe de Inventario'
,p_alias=>'GENERADOR-INFORME-INVENTARIO'
,p_step_title=>'Generador de Informe de Inventario'
,p_autocomplete_on_off=>'OFF'
,p_inline_css=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Informe de Inventario - mismo estilo que el arqueo/KuDE (scope .kude) */',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(36000000000143020)
,p_plug_name=>'Informe'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_plug_display_point=>'BODY'
,p_ajax_items_to_submit=>'P143_OFICINA,P143_CATEGORIA,P143_DESDE,P143_HASTA'
,p_function_body_language=>'PLSQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
'  RETURN WKSP_WORKPLACE.FN_INFORME_INVENTARIO_HTML(',
'    :P143_OFICINA, :P143_CATEGORIA,',
'    TO_DATE(:P143_DESDE,''YYYY-MM-DD''),',
'    TO_DATE(:P143_HASTA,''YYYY-MM-DD''));',
'END;'))
,p_plug_source_type=>'NATIVE_DYNAMIC_CONTENT'
);
--==================== Region Filtros (contenedor plano, se oculta al imprimir) ====
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(36000000000143010)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(36000000000143011)
,p_name=>'P143_OFICINA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(36000000000143010)
,p_prompt=>'Sucursal'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(36000000000143012)
,p_name=>'P143_CATEGORIA'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(36000000000143010)
,p_prompt=>unistr('Categor\00EDa')
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT c.nombre d, c.id_categoria r',
'  FROM WKSP_WORKPLACE.CATEGORIAS_PRODUCTOS c',
' WHERE EXISTS (SELECT 1 FROM WKSP_WORKPLACE.PRODUCTOS p',
'                JOIN WKSP_WORKPLACE.STOCK_PRODUCTO sp ON sp.id_producto = p.id_producto',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(36000000000143014)
,p_name=>'P143_HASTA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(36000000000143010)
,p_item_default=>'TO_CHAR(WKSP_WORKPLACE.FN_HOY,''YYYY-MM-DD'')'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Flujo hasta'
,p_display_as=>'NATIVE_DATE_PICKER_APEX'
,p_format_mask=>'YYYY-MM-DD'
,p_begin_on_new_line=>'N'
,p_field_template=>1609121967514267634
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(36000000000143016)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(36000000000143010)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(36000000000143017)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(36000000000143030)
,p_name=>'Generar informe'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(36000000000143016)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(36000000000143031)
,p_event_id=>wwv_flow_imp.id(36000000000143030)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(36000000000143020)
);
--==================== DA: Imprimir -> window.print() ====================
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(36000000000143032)
,p_name=>'Imprimir'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(36000000000143017)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(36000000000143033)
,p_event_id=>wwv_flow_imp.id(36000000000143032)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
