...
,p_last_updated_on=>wwv_flow_imp.dz('20250911082654Z')
,p_created_by=>'SIS_APEX'
,p_last_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8008815133830855)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8008987054830855)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8010158337830853)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8008987054830855)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8010410767830853)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8011846818830849)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8012195716830849)
,p_name=>'P10010_ALLOW_OTHER_USERS'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(8008815133830855)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8010500582830853)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8010410767830853)
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8011235085830851)
,p_event_id=>wwv_flow_imp.id(8010500582830853)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8012516810830848)
...
,p_internal_uid=>8012516810830848
,p_created_on=>wwv_flow_imp.dz('20240606062353Z')
,p_updated_on=>wwv_flow_imp.dz('20240606062353Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
