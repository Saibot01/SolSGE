...
,p_owner=>nvl(wwv_flow_application_install.get_schema,'WKSP_WORKPLACE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'SOLSGE')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'SOLSGE')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'B076DABC5292FD476C9A6E190B1E11D7D47BFBDC8D4EFDB9D3B94AD5CE99DBE4'
...
,p_authentication_id=>wwv_flow_imp.id(10305647656027707)
...
,p_security_scheme=>wwv_flow_imp.id(14144931354359505)
