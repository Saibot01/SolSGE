...
,p_created_on=>wwv_flow_imp.dz('20250411180126Z')
,p_last_updated_on=>wwv_flow_imp.dz('20250411190542Z')
...
,p_ai_enabled=>false
,p_created_on=>wwv_flow_imp.dz('20250411180126Z')
,p_updated_on=>wwv_flow_imp.dz('20250411180150Z')
,p_created_by=>'SIS_APEX'
...
,p_created_on=>wwv_flow_imp.dz('20250411180126Z')
,p_updated_on=>wwv_flow_imp.dz('20250411180126Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
...
,p_created_on=>wwv_flow_imp.dz('20250411180150Z')
,p_updated_on=>wwv_flow_imp.dz('20250411180150Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
...
,p_created_on=>wwv_flow_imp.dz('20250411180150Z')
,p_updated_on=>wwv_flow_imp.dz('20250411181539Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_item(
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'trim_spaces', 'BOTH')).to_clob
,p_created_on=>wwv_flow_imp.dz('20250411180126Z')
,p_updated_on=>wwv_flow_imp.dz('20250411190542Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
...
,p_created_on=>wwv_flow_imp.dz('20250411180126Z')
,p_updated_on=>wwv_flow_imp.dz('20250411190302Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
