...
,p_created_on=>wwv_flow_imp.dz('20250912205326Z')
,p_last_updated_on=>wwv_flow_imp.dz('20250912234241Z')
...
,p_created_on=>wwv_flow_imp.dz('20250912205327Z')
,p_updated_on=>wwv_flow_imp.dz('20250912232157Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_button(
...
,p_created_on=>wwv_flow_imp.dz('20250912205327Z')
,p_updated_on=>wwv_flow_imp.dz('20250912234241Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_item(
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'min_chars', '0')).to_clob
,p_created_on=>wwv_flow_imp.dz('20250912205327Z')
,p_updated_on=>wwv_flow_imp.dz('20250912215318Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_item(
...
,p_created_on=>wwv_flow_imp.dz('20250912205327Z')
,p_updated_on=>wwv_flow_imp.dz('20250912222022Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
