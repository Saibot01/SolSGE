...
,p_created_on=>wwv_flow_imp.dz('20250430043946Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260415221329Z')
...
,p_created_on=>wwv_flow_imp.dz('20250430043947Z')
,p_updated_on=>wwv_flow_imp.dz('20250430043947Z')
,p_created_by=>'SIS_APEX'
...
,p_created_on=>wwv_flow_imp.dz('20250430043947Z')
,p_updated_on=>wwv_flow_imp.dz('20251010233046Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_button(
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'min_chars', '0')).to_clob
,p_created_on=>wwv_flow_imp.dz('20250430043947Z')
,p_updated_on=>wwv_flow_imp.dz('20250430053104Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_item(
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'show_line_breaks', 'Y')).to_clob
,p_created_on=>wwv_flow_imp.dz('20250430043947Z')
,p_updated_on=>wwv_flow_imp.dz('20250430052408Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_item(
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'trim_spaces', 'BOTH')).to_clob
,p_created_on=>wwv_flow_imp.dz('20250430043947Z')
,p_updated_on=>wwv_flow_imp.dz('20250430050015Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_item(
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'trim_spaces', 'BOTH')).to_clob
,p_created_on=>wwv_flow_imp.dz('20250430043947Z')
,p_updated_on=>wwv_flow_imp.dz('20251010233157Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
...
,p_created_on=>wwv_flow_imp.dz('20250430052409Z')
,p_updated_on=>wwv_flow_imp.dz('20250430053104Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
...
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
,p_created_on=>wwv_flow_imp.dz('20250430053300Z')
,p_updated_on=>wwv_flow_imp.dz('20250430053300Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_da_action(
...
,p_created_on=>wwv_flow_imp.dz('20260328111615Z')
,p_updated_on=>wwv_flow_imp.dz('20260415221329Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_process(
...
,p_created_on=>wwv_flow_imp.dz('20250430043947Z')
,p_updated_on=>wwv_flow_imp.dz('20260330085510Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_process(
...
,p_created_on=>wwv_flow_imp.dz('20250430043947Z')
,p_updated_on=>wwv_flow_imp.dz('20260414100642Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_process(
