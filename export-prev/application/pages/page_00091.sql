...
,p_created_on=>wwv_flow_imp.dz('20251102103052Z')
,p_last_updated_on=>wwv_flow_imp.dz('20251102112704Z')
...
,p_created_on=>wwv_flow_imp.dz('20251102103206Z')
,p_updated_on=>wwv_flow_imp.dz('20251102103744Z')
,p_created_by=>'WILLIAN'
...
,p_created_on=>wwv_flow_imp.dz('20251102103206Z')
,p_updated_on=>wwv_flow_imp.dz('20251102103756Z')
,p_created_by=>'WILLIAN'
,p_updated_by=>'WILLIAN'
);
...
,p_created_on=>wwv_flow_imp.dz('20251102103206Z')
,p_updated_on=>wwv_flow_imp.dz('20251102112251Z')
,p_created_by=>'WILLIAN'
,p_updated_by=>'WILLIAN'
);
wwv_flow_imp_page.create_page_item(
...
,p_created_on=>wwv_flow_imp.dz('20251102103318Z')
,p_updated_on=>wwv_flow_imp.dz('20251102112251Z')
,p_created_by=>'WILLIAN'
,p_updated_by=>'WILLIAN'
);
...
,p_created_on=>wwv_flow_imp.dz('20251102112155Z')
,p_updated_on=>wwv_flow_imp.dz('20251102112704Z')
,p_created_by=>'WILLIAN'
,p_updated_by=>'WILLIAN'
);
wwv_flow_imp_page.create_page_process(
...
,p_created_on=>wwv_flow_imp.dz('20251102112503Z')
,p_updated_on=>wwv_flow_imp.dz('20251102112704Z')
,p_created_by=>'WILLIAN'
,p_updated_by=>'WILLIAN'
);
