...
,p_page_mode=>'MODAL'
,p_step_title=>'Factura Proveedor Documento'
...
,p_created_on=>wwv_flow_imp.dz('20251102204129Z')
,p_last_updated_on=>wwv_flow_imp.dz('20251121122301Z')
...
'  JOIN PROVEEDORES PR ON PR.ID_PERSONA = C.ID_PROVEEDOR',
'  JOIN PERSONAS PE ON PE.ID_PERSONA = PR.ID_PERSONA',
unistr(' WHERE C.ID_COMPROBANTE = :P97_ID_COMPROBANTE;  -- Par\00E1metro de entrada'),
'',
...
'      D.PRECIO_UNITARIO,',
'      D.TOTAL',
'    FROM DETALLE_COMPROBANTE_PROV D',
...
'      <address>',
'        <h5>',
'          RUC: '' || v_comp.RUC_PROVEEDOR || ''<br>',
unistr('          Raz\00F3n Social: '' || v_comp.PROVEEDOR || ''<br>'),
...
'        <td><span>'' || v_comp.TIPO_COMPROBANTE || ''</span></td>',
'      </tr>',
'      <tr>',
...
'      </tr>',
'      <tr>',
'        <th><span>Nro. Timbrado</span></th>',
'        <td><span>'' || v_comp.NRO_TIMBRADO || ''</span></td>',
'      </tr>',
'      <tr>',
unistr('        <th><span>Fecha Emisi\00F3n</span></th>'),
'        <td><span>'' || TO_CHAR(v_comp.FECHA_EMISION, ''dd/mm/yyyy'') || ''</span></td>',
'      </tr>',
'      <tr>',
...
'        <td><span data-prefix>Gs.</span><span>'' || TO_CHAR(v_det.TOTAL, ''999G999G990D00'') || ''</span></td>',
'      </tr>'';',
'    END LOOP;',
'',
'    v_html := v_html || ''',
...
,p_created_on=>wwv_flow_imp.dz('20251102204510Z')
,p_updated_on=>wwv_flow_imp.dz('20251121122301Z')
,p_created_by=>'WILLIAN'
...
,p_created_on=>wwv_flow_imp.dz('20251102204510Z')
,p_updated_on=>wwv_flow_imp.dz('20251102204510Z')
,p_created_by=>'WILLIAN'
,p_updated_by=>'WILLIAN'
);
