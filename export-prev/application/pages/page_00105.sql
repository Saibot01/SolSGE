...
,p_created_on=>wwv_flow_imp.dz('20260513025232Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260513040358Z')
...
,p_created_on=>wwv_flow_imp.dz('20260513025233Z')
,p_updated_on=>wwv_flow_imp.dz('20260513034505Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_button(
...
,p_created_on=>wwv_flow_imp.dz('20260513025233Z')
,p_updated_on=>wwv_flow_imp.dz('20260513032904Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_item(
...
,p_created_on=>wwv_flow_imp.dz('20260513025233Z')
,p_updated_on=>wwv_flow_imp.dz('20260513034242Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_item(
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260513025233Z')
,p_updated_on=>wwv_flow_imp.dz('20260513034321Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_item(
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260513025233Z')
,p_updated_on=>wwv_flow_imp.dz('20260513033211Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_item(
...
,p_created_on=>wwv_flow_imp.dz('20260513025233Z')
,p_updated_on=>wwv_flow_imp.dz('20260513035423Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_item(
...
,p_created_on=>wwv_flow_imp.dz('20260513034242Z')
,p_updated_on=>wwv_flow_imp.dz('20260513034242Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
...
,p_associated_item=>wwv_flow_imp.id(20422221358365915)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_created_on=>wwv_flow_imp.dz('20260513034540Z')
,p_updated_on=>wwv_flow_imp.dz('20260513034540Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
...
,p_created_on=>wwv_flow_imp.dz('20260513032904Z')
,p_updated_on=>wwv_flow_imp.dz('20260513040358Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
