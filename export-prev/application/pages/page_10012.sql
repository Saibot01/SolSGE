...
,p_last_updated_on=>wwv_flow_imp.dz('20250911082729Z')
,p_created_by=>'SIS_APEX'
,p_last_updated_by=>'SIS_APEX'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8019322239830829)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8019443807830829)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8022271570830827)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(8019443807830829)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8022679425830826)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8020452081830828)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8021836388830828)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8022987500830826)
,p_name=>'P10012_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8019322239830829)
,p_item_source_plug_id=>wwv_flow_imp.id(8019322239830829)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8023328883830826)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8023753355830826)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8024128522830825)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8025369822830817)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8020575540830828)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8020452081830828)
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8021290365830828)
,p_event_id=>wwv_flow_imp.id(8020575540830828)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8025625034830817)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(8019322239830829)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Initialize form Manage User Access'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>8025625034830817
,p_created_on=>wwv_flow_imp.dz('20240606062354Z')
,p_updated_on=>wwv_flow_imp.dz('20240606062354Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8026037179830816)
...
,p_attribute_08=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>8026037179830816
,p_created_on=>wwv_flow_imp.dz('20240606062354Z')
,p_updated_on=>wwv_flow_imp.dz('20240606062354Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8026479273830816)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>8026479273830816
,p_created_on=>wwv_flow_imp.dz('20240606062354Z')
,p_updated_on=>wwv_flow_imp.dz('20240606062354Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
