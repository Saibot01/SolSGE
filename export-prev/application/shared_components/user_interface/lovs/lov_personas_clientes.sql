...
,p_created_on=>wwv_flow_imp.dz('20250408094717Z')
,p_updated_on=>wwv_flow_imp.dz('20250411163948Z')
...
,p_is_visible=>'N'
,p_is_searchable=>'N'
,p_created_on=>wwv_flow_imp.dz('20250408101603Z')
,p_updated_on=>wwv_flow_imp.dz('20250411163948Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
...
,p_created_on=>wwv_flow_imp.dz('20250409054058Z')
,p_updated_on=>wwv_flow_imp.dz('20250411163948Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
...
,p_data_type=>'VARCHAR2'
,p_created_on=>wwv_flow_imp.dz('20250409053135Z')
,p_updated_on=>wwv_flow_imp.dz('20250411163948Z')
,p_created_by=>'SIS_APEX'
,p_updated_by=>'SIS_APEX'
);
